...
//        user.getRoles().add(roleRepository.findByName("ROLE_USER"));
    ...
    public void changeProfileInfo(User newProfileInfo) {
        ...
        user.setDateOfBirth(newProfileInfo.getDateOfBirth());

        user.setPhoneNumber(newProfileInfo.getPhoneNumber());

        user.setStreetAddress(newProfileInfo.getStreetAddress());

        user.setCity(newProfileInfo.getCity());

        user.setState(newProfileInfo.getState());

        user.setZipCode(newProfileInfo.getZipCode());
